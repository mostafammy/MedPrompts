...
describe('getActiveTemplate', () => {
  ...
  beforeAll(async () => {
    ...
    await client.execute('CREATE TABLE IF NOT EXISTS prompt_templates (id TEXT PRIMARY KEY, subject_id TEXT NOT NULL, template TEXT NOT NULL, version INTEGER NOT NULL, is_active INTEGER NOT NULL DEFAULT 0, changelog TEXT, created_at INTEGER NOT NULL, FOREIGN KEY (subject_id) REFERENCES subjects(id))');
