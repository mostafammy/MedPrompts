...
export function HomePageClient({ subjects }: { subjects: Subject[] }) {
  ...
  const { history, bookmarks, isLoaded, removeHistoryItem, removeBookmark } = usePromptHistory();
              ...
              bookmarks.length === 0 ? (
                ...
                bookmarks.map((item) => (
                  <div
                    ...
                    className="relative group p-5 bg-white dark:bg-zinc-900/60 backdrop-blur border border-zinc-200 dark:border-zinc-800/80 rounded-2xl hover:border-blue-500 dark:hover:border-blue-500/50 hover:shadow-lg hover:shadow-blue-500/5 transition-all duration-300 cursor-pointer flex flex-col justify-between"
                  >
                    <div>
